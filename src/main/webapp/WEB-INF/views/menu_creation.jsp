																			...
																			.each(
																					...
																					function(
																						...
																						text2 += ""
																								...
																								+ "')\" data-toggle=\"modal\" data-original-title=\"Add to Project\" data-placement=\"top\" style=\"border-radius:40px; padding:4px 6px 2px;\" class=\"btn btn-xl btn-success button-submit font13 bs-tooltip\"> "
																			...
																			.each(
																					...
																					function(
																						...
																						text2 += ""
																								+ "<tr class=\"odd\"> "
																								+ "                          <td class=\" \"> "
																								+ "                          	<a href=\"#\" onclick=\"updateMenu('module_id','"
																								+ MainMenuEntityList.menuId
																								+ "','"
																								+ MainMenuEntityList.menuName
																								+ "','"
						...
						<div id="my_documents_container" style=""
							...
							<div class="row">
								<div class="create_project_tbl">
									...
									<div class="grid-header text">Menu Master</div>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-7">
														<select id="module_id" title="module" name="ModuleId"
															class="form-control" placeholder="Please Enter Society Reg No">
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-7">
														<input name="menuName" type="text" maxlength="40"
															...
															placeholder="Enter Menu Name"> <span
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-7">
														<input name="menuLink" type="text" maxlength="100"
															...
															onkeypress="return CheckAlphaNumeric(event,this)"
															placeholder="Enter Menu Link"> <span
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-7">
														<input name="menuSerialNumber" type="text" maxlength="10"
															...
															placeholder="Enter  Menu Sr.Number"> <span
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-7">
														<input id="menu_status" value="1" type="checkbox"
															name="menuStatus" checked="checked" tabindex="8"><label
